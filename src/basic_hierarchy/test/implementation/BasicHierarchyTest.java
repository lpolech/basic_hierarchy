...
//          find corresponding child in original hierarchy in compare content
    ...
    public void generateOneClusterFromHierarchy(){
        Hierarchy h = TestCommon.getFourGroupsHierarchy();
        Hierarchy oneCluster = Utils.getOneClusterHierarchy(h);
        ...
        LinkedList<String> oneClusterInstancesIDs = getCollectionOfInstanceNames(oneCluster.getRoot().getNodeInstances());
